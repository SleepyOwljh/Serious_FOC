...
const VideoSection = () => {
  return (
    <section className="py-24 bg-darkBg flex justify-center px-4">
      <div className="w-full max-w-5xl aspect-video bg-white/5 rounded-2xl overflow-hidden border border-white/10 relative group">
